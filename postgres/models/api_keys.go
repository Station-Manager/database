...
var APIKeyWhere = struct {
	...
	AllowedIps: whereHelpertypes_StringArray{field: "\"api_keys\".\"allowed_ips\""},
	...
	RevokedBy:  whereHelpernull_String{field: "\"api_keys\".\"revoked_by\""},
	UseCount:   whereHelpernull_Int64{field: "\"api_keys\".\"use_count\""},
}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(apiKeyPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert api_keys, could not build conflict column list")
			}
