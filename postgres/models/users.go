...
type userR struct {
	Logbooks LogbookSlice `boil:"Logbooks" json:"Logbooks" toml:"Logbooks" yaml:"Logbooks"`
}
...
func (o *User) GetLogbooks() LogbookSlice {
	...
	return o.R.GetLogbooks()
}

func (r *userR) GetLogbooks() LogbookSlice {
	if r == nil {
		return nil
	}
...
func (o *User) Logbooks(mods ...qm.QueryMod) logbookQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"logbook\".\"user_id\"=?", o.ID),
	)

	return Logbooks(queryMods...)
}

// LoadLogbooks allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadLogbooks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`logbook`),
		qm.WhereIn(`logbook.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on logbook")
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.Logbooks = append(local.R.Logbooks, foreign)
				if foreign.R == nil {
					foreign.R = &logbookR{}
				}
...
// AddLogbooks adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Logbooks.
...
func (o *User) AddLogbooks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Logbook) error {
	...
	if o.R == nil {
		...
		o.R.Logbooks = append(o.R.Logbooks, related...)
	}
